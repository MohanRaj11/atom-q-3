...
export default function AnalysisPage() {
  ...
  const quizPerformanceData = [
    { name: 'Easy', attempts: 45, avgScore: 85 },
    { name: 'Medium', attempts: 32, avgScore: 72 },
    { name: 'Hard', attempts: 18, avgScore: 58 },
  ]

  const categoryDistributionData = [
    { name: 'General Knowledge', value: 35 },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle>Quiz Performance by Difficulty</CardTitle>
            <CardDescription>
